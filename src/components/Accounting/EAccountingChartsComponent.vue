  ...
  data() {
    return {
      ...
      chart: null,
			...
			v: new Object(),
			days: [
				{ id: "01", value: moment(new Date()).format('YYYY')+'-01-26' },
				{ id: "02", value: moment(new Date()).format('YYYY')+'-02-26' },
				{ id: "03", value: moment(new Date()).format('YYYY')+'-03-26' },
				{ id: "04", value: moment(new Date()).format('YYYY')+'-04-26' },
				{ id: "05", value: moment(new Date()).format('YYYY')+'-05-26' },
				{ id: "06", value: moment(new Date()).format('YYYY')+'-06-26' },
				{ id: "07", value: moment(new Date()).format('YYYY')+'-07-26' },
				{ id: "08", value: moment(new Date()).format('YYYY')+'-08-26' },
				{ id: "09", value: moment(new Date()).format('YYYY')+'-09-26' },
				{ id: "10", value: moment(new Date()).format('YYYY')+'-10-26' },
				{ id: "11", value: moment(new Date()).format('YYYY')+'-11-26' },
				{ id: "12", value: moment(new Date()).format('YYYY')+'-12-26' },
				// { id: 14, value: 'Sábado' },
			],
    }
  },
