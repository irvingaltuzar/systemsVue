<template>
  <div>
    <md-dialog :md-active.sync="showDialog">
      <md-dialog-title class="dialog-header">Registrar nueva empresa</md-dialog-title>
            ...
            <div class="md-layout md-gutter mt-3">
              ...
              <div class="md-layout-item md-small-size-100">
                <md-field>
                  ...
                  <el-select class="input-autocomplete" v-model="f.manager_id" filterable placeholder="Selecciona un Gerente">
                    <el-option v-for="item in managers" :key="item.id" :label="item.name +' '+item.last_name" :value="item.usuario_ad"></el-option>
                  </el-select>
                </md-field>
            ...
            <div class="md-layout md-gutter mt-3">
              ...
              <div class="md-layout-item md-small-size-100">
                <md-field>
                  ...
                  <el-select class="input-autocomplete" v-model="f.accountant_id" filterable placeholder="Selecciona un Contador">
                    <el-option v-for="item in accountants" :key="item.id" :label="item.name +' '+item.last_name" :value="item.usuario_ad"></el-option>
                  </el-select>
                </md-field>
...
export default {
  name: 'CreateAccountingCompanyComponent',
  data: () => ({
    showDialog: false,
    is_loaded: null,
    f: {
  ...
  methods: {
    ...
    store() {
      this.disabled = true
      Api.post('/accounting/companies/store', {
