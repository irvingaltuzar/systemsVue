      ...
      <br>
        ...
        <el-table
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <span class="label">{{scope.row.date_accounting}}</span>
              <div v-if="scope.row.file_accounting != null && scope.row.file_accounting != ''">
                <br>
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <span class="label">{{scope.row.date_fiscal}}</span>
              <div v-if="scope.row.file_fiscal != null && scope.row.file_accounting != ''">
                <br>
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <span class="label">{{scope.row.date_payment}}</span>
              <div v-if="scope.row.file_payment != null && scope.row.file_accounting != ''">
                <br>
  ...
  methods: {
    ...
    async getList(_page = 1){
      ...
      .then(response =>{
        ...
        formAut.append('comentarios', "Visualización de Cierre Mensual")
        formAut.append('id_afectado',"null")
        formAut.append('evento', 'Cierre Mensual -> getList()')
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          .then(response =>{
            ...
            const formAut = new FormData()
            formAut.append('name_view', this.$route.name)
            formAut.append('comentarios', "Eliminación de archivo con id: "+_field)
            formAut.append('id_afectado',_id_mounthly_closure)
            formAut.append('evento', 'Cierre Mensual -> deleteFile()')
