        ...
        <div v-else class="m-2">
            <md-content>
              ...
              <el-row class="mt-3">
                ...
                <el-col class="col-sm-12 col-md-4">
                  <el-date-picker v-model="form_request.date_accounting" type="date" placeholder="Contabilidad"></el-date-picker>
                </el-col>
                <el-col class="col-sm-12 col-md-6">
                  <el-upload
                    action="#"
  ...
  methods: {
    _tempCreated:function(_data){
      ...
      if(_data.type_event == "edit"){
        ...
        this.form_request.date_accounting= this.form_request.date_accounting != null ? moment(this.form_request.date_accounting) : null;
        this.form_request.date_fiscal= this.form_request.date_fiscal != null ? moment(this.form_request.date_fiscal) : null;
        this.form_request.date_payment= this.form_request.date_payment != null ? moment(this.form_request.date_payment) : null;
      ...
      if(this.validateForm()){
        ...
        .then(response =>{
          if(response.data.success == 1){
            ...
            formAut.append('comentarios', "Agregar Cierre Mensual")
            formAut.append('id_afectado',response.data.data.id)
            formAut.append('evento', 'Cierre Mensual -> saveRecord()')
      ...
      if(this.validateForm()){
        ...
        .then(response =>{
          if(response.data.success == 1){
            ...
            const formAut = new FormData()
            formAut.append('name_view', this.$route.name)
            formAut.append('comentarios', "Actualización de Cierre Mensual")
            formAut.append('id_afectado',this.form_request.id)
            formAut.append('evento', 'Cierre Mensual -> updateRecor()')
