      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-tooltip v-if="scope.row.status != 'cancelado'" class="item" effect="dark" content="Cancelar permiso" placement="bottom">
              <el-button
                size="mini"
                type="danger"
                circle
...
export default {
  ...
  methods: {
    async getList(_page = 1){
      ...
      await Api.get('/rh/work-permits/list',{
        params:this.headers
      })
      .then(response =>{
        ...
        formAut.append('comentarios', "Mis Permisos")
        ...
        if (result.isConfirmed) {
          ...
          .then(response =>{
            ...
            if(response.data.success == 1){
              ...
              formAut.append('evento', 'Permisos -> Cancela registro()')
          ...
          .catch(error =>{
            this.fullscreenLoading = false;
            console.log(error,"/rh/work-permits/cancel/"+_id);
            this.$notify({
                  title:"Aviso",
                  message: "A ocurrido un error, intente de nuevo",
                  type:"error",
