...
export default {
  ...
  methods: {
    async getList(_page = 1){
      ...
      await Api.get('/rh/work-permits/staff-permit-list',{
        params:this.headers
      })
      .then(response =>{
        ...
        formAut.append('comentarios', "Permisos de Personal")
      ...
      .catch(error =>{
        console.log('/rh/work-permits/staff-permit-list',error);
        this.loading_get_list = false
